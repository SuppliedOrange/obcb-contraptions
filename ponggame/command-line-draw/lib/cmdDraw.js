...
const bm = { // stands for bitmap
  r000: [false, false, false],
  r001: [false, false, true],
  r010: [false, true, false],
  r011: [false, true, true],
  r100: [true, false, false],
  r101: [true, false, true],
  r110: [true, true, false],
  r111: [true, true, true]
};
...
class Terminal extends EventEmitter {
  constructor (config = {}) {
    ...
    this.out.write("\x1b[?1049h"); // Enter alternate screen
  ...
  write (text, x, y, color, backgroundColor) {
    if (this.clearMode) {
      color = this.color.background;
    ...
    if (color) this.out.write(Color.getForegroundColor(color));
    if (backgroundColor) this.out.write(Color.getBackgroundColor(backgroundColor));
    ...
    this.out.write(text);
    if (color || backgroundColor) this.color.refresh();
  }
  clear () {
  ...
  bitmap (x, y, color, ...matrixes) {
    ...
    for (let matrix of matrixes) {
      ...
      for (let row in matrix) {
        ...
        if (matrix[row].length * 2 + x > this.width) throw outsideTerminalError;
  ...
  static bitmapPresets = {
    letters: {
      A: [bm.r010, bm.r101, bm.r101, bm.r111, bm.r101],
      B: [bm.r110, bm.r101, bm.r110, bm.r101, bm.r110],
      C: [bm.r011, bm.r100, bm.r100, bm.r100, bm.r011],
      D: [bm.r110, bm.r101, bm.r101, bm.r101, bm.r110],
      E: [bm.r111, bm.r100, bm.r111, bm.r100, bm.r111],
      F: [bm.r111, bm.r100, bm.r111, bm.r100, bm.r100],
      G: [bm.r011, bm.r100, bm.r101, bm.r101, bm.r011],
      H: [bm.r101, bm.r101, bm.r111, bm.r101, bm.r101],
      I: [bm.r111, bm.r010, bm.r010, bm.r010, bm.r111],
      J: [bm.r111, bm.r001, bm.r001, bm.r101, bm.r010],
      K: [bm.r101, bm.r101, bm.r110, bm.r101, bm.r101],
      L: [bm.r100, bm.r100, bm.r100, bm.r100, bm.r111],
      M: [
      ...
      N: [bm.r111, bm.r101, bm.r101, bm.r101, bm.r101],
      O: [bm.r111, bm.r101, bm.r101, bm.r101, bm.r111],
      P: [bm.r110, bm.r101, bm.r110, bm.r100, bm.r100],
      Q: [bm.r110, bm.r101, bm.r110, bm.r001, bm.r001],
      R: [bm.r110, bm.r101, bm.r110, bm.r101, bm.r101],
      S: [bm.r111, bm.r100, bm.r111, bm.r001, bm.r111],
      T: [bm.r111, bm.r010, bm.r010, bm.r010, bm.r010],
      U: [bm.r101, bm.r101, bm.r101, bm.r101, bm.r111],
      V: [bm.r101, bm.r101, bm.r101, bm.r101, bm.r010],
      W: [
        [true, false, true, false, true],
        [true, false, true, false, true],
        [true, false, true, false, true],
      ...
      X: [bm.r101, bm.r101, bm.r010, bm.r101, bm.r101],
      Y: [bm.r101, bm.r101, bm.r111, bm.r010, bm.r010],
      Z: [bm.r111, bm.r001, bm.r010, bm.r100, bm.r111],
    },
    punctuation: {
      ".": [
        [false],
      ...
      "?": [bm.r110, bm.r001, bm.r010, bm.r000, bm.r010]
    }
  }
};
